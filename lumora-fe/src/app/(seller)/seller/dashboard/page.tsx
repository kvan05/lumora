  ...
  const statCards = [
    {
      ...
      subtitle: "Xem tài chính & rút tiền",
      icon: DollarSign,
    ...
    {
      title: "Đơn Hàng & Vé Đã Bán",
      value: `+${stats?.totalOrders || 0}`,
      subtitle: "Xem quản lý vé & đơn hàng",
      icon: Ticket,
    ...
    },
    {
      title: "Khách Hàng",
      value: "Quản lý",
      subtitle: "Xem danh sách khán giả",
      icon: Users,
  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h2 className="text-3xl font-extrabold tracking-tight text-foreground">Tổng quan Dashboard</h2>
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-4">
        {statCards.map((stat, i) => (
          <Card
            ...
            className="rounded-2xl border-border/50 shadow-sm hover:shadow-lg hover:border-primary/50 transition-all overflow-hidden relative group cursor-pointer hover:scale-[1.01]"
          >
            ...
            <CardContent>
              ...
              <p className="text-xs font-medium text-primary flex items-center gap-1 group-hover:underline">
